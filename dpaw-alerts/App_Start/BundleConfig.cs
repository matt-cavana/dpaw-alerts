...
namespace dpaw_alerts
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //custom bundle for theme
            bundles.Add(new ScriptBundle("~/bundles/date").Include("~/Scripts/moment.js", "~/Scripts/jquery.datetimepicker.full.js"));

            //custom bundle for theme
            bundles.Add(new ScriptBundle("~/bundles/form").Include("~/Scripts/bootstrap-datepicker.min.js", "~/Scripts/bootstrap-timepicker.min.js", "~/Scripts/bootstrap-slider.min.js",
          ...
          //  bundles.Add(new ScriptBundle("~/bundles/globalization").IncludeDirectory("~/Scripts/globalize-culture", "*.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/alerts").Include("~/Scripts/app/alerts.js"));
            ...
            //custom bundle for theme
            bundles.Add(new ScriptBundle("~/bundles/publicjs").Include("~/Scripts/pace.min.js", "~/Scripts/jquery-{version}.js",
                 "~/Scripts/jquery.dataTables.min.js", "~/Scripts/jquery.slimscroll.min.js", "~/Scripts/jquery.popupoverlay.min.js",
                 "~/Scripts/app/app.js"));

            bundles.Add(new StyleBundle("~/Content/pubcss").Include(
