...
$(function () {
    ...
    //set the data table
    var table = $('#DPaWDataTable').DataTable({
...
$(function(){
    ...
    map = L.map('lmap', {
        center: latlng, zoom: 6, fullscreenControl: true,
    ...
    function loadMap() {
        ...
        }, { 'Munda Biddi': mtrack, 'Cape to Cape': ctrack, 'Bibbulmun': btrack, 'Wiilman Bilya': wtrack }, {
            collapsed: true
        }).addTo(map);
