...
namespace dpaw_alerts.Services
{
    ...
    public class FacebookJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            // parameters.picture = "https://ratisweb.dpaw.wa.gov.au/alerts/img/logo.png";
    ...
    public class SMSJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            if (job.Id > 0)
            {
                string bdy = job.alert.Title + ". Visit https://ratisweb.dpaw.wa.gov.au/alerts/ for details. Reply STOP to unsubscribe.";
