...
$(function(){
	...
	var mapbox_accesstoken = "pk.eyJ1IjoiZHBhd2FzaSIsImEiOiJjamxmeHM5OGswdnA2M3FydmJ2YW9xa2Z6In0.wAnkinx2kKEZLxU1vzvyIw"
		var roadMutant = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?access_token={mbkey}", {mbkey: mapbox_accesstoken});
		...
		var terrainMutant = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/outdoors-v11/tiles/{z}/{x}/{y}?access_token={mbkey}", {mbkey: mapbox_accesstoken});
        var hybridMutant = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v11/tiles/{z}/{x}/{y}?access_token={mbkey}", {mbkey: mapbox_accesstoken});
		


	var map = L.map('lmap', { center: latlng, zoom: 6, maxZoom: 24, tileSize: 512, });
